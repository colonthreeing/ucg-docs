...
![The file manager Dolphin from KDE is pictured, open to the directory "Downloads/uncanny-cat-golf-linux" directory. The file "Uncanny Cat Golf" is circled with a useless red circle, adorned by multiple red arrows pointing at it in all of its glory](../../../assets/getting-started/decompiling/the_pck.png)
...
![What the text above said, just in image form with big red arrows.](../../../assets/getting-started/decompiling/open_the_pck.png)
...
![More red arrows showing visually what the text above says](../../../assets/getting-started/decompiling/extractinator.png)
